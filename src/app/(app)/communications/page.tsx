...
const nextStatus = (status: string) => ({ DRAFT: "IN_REVIEW", IN_REVIEW: "APPROVED", APPROVED: "PUBLISHED", PUBLISHED: "ARCHIVED" } as const)[status as "DRAFT"] ?? null;
